        ...
        <div className="xl:col-span-2 space-y-8">
             ...
             <section aria-label="Your Accounts">
                <div className="flex justify-between items-center mb-4 px-1">
                    ...
                    <button onClick={() => setActiveView('accounts')} className="text-xs font-bold text-primary-400 hover:text-primary-300 tracking-wide uppercase transition-colors">Manage All</button>
                </div>
